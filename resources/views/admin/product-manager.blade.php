                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2">
                                <a href="{{ route('admin.product-manager', ['tab' => 'biaya-desain']) }}" 
                                   class="btn {{ $activeTab == 'biaya-desain' ? 'btn-primary' : 'btn-light' }} w-100 py-3">
                    ...
                    <div>
                        ...
                        <div class="table-responsive">
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    @forelse($biaya_desains ?? [] as $biaya)
                                    <tr>
                                        <td>{{ $biaya['id'] }}</td>
...
<!-- Import semua modal -->
@include('admin.components.modals.item_modal')
@include('admin.components.modals.bahan_modal')
@include('admin.components.modals.ukuran_modal')
@include('admin.components.modals.jenis_modal')
@include('admin.components.modals.biaya_desain_modal')
@endsection
