...
Route::middleware(['auth.check', 'role:user'])->group(function () {
    Route::get('/user/welcome', fn() => redirect()->route('welcome'))->name('user.welcome');
    Route::get('/profile', [ProfileController::class, 'showProfile'])->name('user.profile');
    Route::post('/profile/update-password', [ProfileController::class, 'updatePassword'])->name('profile.update-password');

    // Keranjang
    Route::prefix('keranjang')->name('keranjang.')->group(function () {
        Route::get('/', [App\Http\Controllers\User\KeranjangController::class, 'index'])->name('index');
        Route::post('/add', [App\Http\Controllers\User\KeranjangController::class, 'addToCart'])->name('add');
        Route::put('/{id}/quantity', [App\Http\Controllers\User\KeranjangController::class, 'updateQuantity'])->name('update-quantity');
        Route::post('/{id}/upload-design', [App\Http\Controllers\User\KeranjangController::class, 'uploadDesign'])->name('upload-design');
        Route::delete('/{id}', [App\Http\Controllers\User\KeranjangController::class, 'removeItem'])->name('remove');
        Route::delete('/', [App\Http\Controllers\User\KeranjangController::class, 'clearCart'])->name('clear');
        Route::get('/count', [App\Http\Controllers\User\KeranjangController::class, 'getCartCount'])->name('count');
    });
